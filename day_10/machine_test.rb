...
class MachineTest < Minitest::Test
  def test_should_parse_lines_from_manual
    ...
    assert_equal [ 3, 5, 4, 7 ], parser.joltage
  end
  ...
  def test_should_find_fewest_joltage_increases
    assert_equal 10, Machine.new("[.##.] (3) (1,3) (2) (2,3) (0,2) (0,1) {3,5,4,7}").fewest_joltage
    assert_equal 12, Machine.new("[...#.] (0,2,3,4) (2,3) (0,4) (0,1,2) (1,2,3,4) {7,5,12,7,2}").fewest_joltage
    assert_equal 11, Machine.new("[.###.#] (0,1,2,3,4) (0,3,4) (0,1,2,4,5) (1,2) {10,11,11,5,10,5}").fewest_joltage
  end
end
